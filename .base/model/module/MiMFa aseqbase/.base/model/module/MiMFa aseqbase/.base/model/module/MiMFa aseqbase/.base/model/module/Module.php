...
class Module extends \Base{
	...
	public function EchoTitle(){
		if(isValid($this->Title)){
            echo (isValid($this->TitleTag)?"<".$this->TitleTag.">":"").__($this->Title).(isValid($this->TitleTag)?"</".$this->TitleTag.">":"");
            return true;
        }
        return false;
    }
	public function EchoDescription(){
		if(isValid($this->Description)){
			echo (isValid($this->DescriptionTag)?"<".$this->DescriptionTag.">":"").__($this->Description).(isValid($this->DescriptionTag)?"</".$this->DescriptionTag.">":"");
            return true;
        }
        return false;
    }
	public function EchoContent(){
		if(isValid($this->Content)){
			if(is_string($this->Content))
				echo (isValid($this->ContentTag)?"<".$this->ContentTag.">":"").$this->Content.(isValid($this->ContentTag)?"</".$this->ContentTag.">":"");
            else ($this->Content)();
            return true;
        }
        return false;
