...
\_::$Front->Libraries[] = Struct::Style(null, asset(\_::$Router->PackageDirectory, "DataTable/Style.css", optimize: false));
\_::$Front->Libraries[] = Struct::Script(null, asset(\_::$Router->PackageDirectory, "DataTable/Script.js", optimize: false));
