...
class QRCodeScanner extends Module
{
	...
	{
		if ($this->Local)
			$this->ScriptSource = asset(\_::$Router->PackageDirectory, "Scanner/Script.js");
	...
	public function GetScript()
	{
		...
		try{
			if(!Instascan.Scanner) Struct.script.load(null, '" . asset(\_::$Router->PackageDirectory, "Scanner/Script.js", optimize: true) . "');
			} catch{Struct.script.load(null, '" . asset(\_::$Router->PackageDirectory, "Scanner/Script.js", optimize: true) . "');}
