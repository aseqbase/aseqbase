...
if ($Name) $templ->Content = ($module->Title || $module->Description || $module->Content || $module->Image?$module->Handle():"").\MiMFa\Library\Struct::Page(part($Name, data: $data, print: false)??view($alternative, data: $data, print: false));
