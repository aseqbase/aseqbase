...
if (\_::$Front->AnimationSpeed) {
	...
	\_::$Front->Initials[] =
		...
		Struct::Style(null, asset(\_::$Address->StructRootDirectory,'animate/Animate.css')) .
		Struct::Script(null, asset(\_::$Address->StructRootDirectory,'animate/Animate.js'), ['crossorigin' => 'anonymous']);
