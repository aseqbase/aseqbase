...
class Splash extends Template{
	...
	<style>
		...
		.splash-view .frame-3 {
			...
			animation: none;
			color: transparent;
			text-shadow: 0px 0px 1px  var(--fore-color-special-output);
		}
		.splash-view .frame-3>* {
			width: fit-content;
			display: inline-block;
		...
		@keyframes blurFadeInOut{
			0%{
				opacity: 0;
				display: none;
				text-shadow: 0px 0px 40px var(--fore-color-special-output);
				transform: scale(0.9);
			}
			20%,75%{
				opacity: 1;
			...
			100%{
				opacity: 0;
				display: none;
				text-shadow: 0px 0px 50px var(--fore-color-special-output);
				transform: scale(0);
			}
		}
		@keyframes blurFadeIn{
			...
			50%{
				opacity: 0.5;
				text-shadow: 0px 0px 10px var(--fore-color-special-output);
				transform: scale(1.1);
			}
			100%{
				opacity: 1;
