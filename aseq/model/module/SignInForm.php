	...
	public function Post(){
		if(!\_::$User->HasAccess(\_::$User->UserAccess) || $this->MultipleSignIn) try {
			...
			if(isValid($signature) && isValid($password)) {
				...
				elseif(is_null($res))
					return deliverRedirect($this->GetError("This account is not active yet!"), \_::$User->ActiveHandlerPath . "?signature=$signature".(\_::$Address->UrlQuery?"&".\_::$Address->UrlQuery:""));
				else
